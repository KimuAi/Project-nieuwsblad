<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('nieuwsitems.index')" :active="request()->routeIs('nieuwsitems.index')">
                        {{ __('Nieuwsitems') }}
                    </x-nav-link>
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                           class="ml-4 text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium">Register</a>
                    @endif
                @endauth
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('nieuwsitems.index')" :active="request()->routeIs('nieuwsitems.index')">
                {{ __('Nieuwsitems') }}
            </x-responsive-nav-link>
